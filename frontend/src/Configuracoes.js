...
const Configuracoes = () => {
  ...
  try {
    const response = await fetch("https://mgymbackend.onrender.com/usuarios/atualizar-login", {
      method: "PUT",
      headers: {
  ...
  try {
    const response = await fetch("https://mgymbackend.onrender.com/usuarios/atualizar-senha", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
