...
const Configuracoes = () => {
  ...
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/usuarios/atualizar-login`, {
      method: "PUT",
      headers: {
  ...
  try {
    const response = await fetch(`${process.env.REACT_APP_API_URL}/usuarios/atualizar-senha`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${token}`,
